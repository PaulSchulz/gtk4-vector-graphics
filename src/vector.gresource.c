...
# define SECTION __attribute__ ((section (".gresource.vector"), aligned (8)))
#else
# define SECTION
#endif

static const SECTION union { const guint8 data[669]; const double alignment; void * const ptr;}  vector_resource_data = {
  ...
  "\224\000\000\000\230\000\000\000\376\200\025\203\002\000\000\000"
  "\230\000\000\000\011\000\166\000\250\000\000\000\204\002\000\000"
  "\377\000\006\363\003\000\000\000\204\002\000\000\014\000\114\000"
  "\220\002\000\000\224\002\000\000\113\120\220\013\000\000\000\000"
  "\224\002\000\000\004\000\114\000\230\002\000\000\234\002\000\000"
  "\057\000\000\000\003\000\000\000\166\145\143\164\157\162\056\165"
  "\151\000\000\000\000\000\000\000\314\001\000\000\000\000\000\000"
  ...
  "\101\162\145\141\042\040\151\144\075\042\144\151\163\160\154\141"
  "\171\042\076\012\040\040\040\040\040\040\040\040\074\160\162\157"
  ...
  "\165\141\171\051\155\141\167\163\157\156\154\141\153\145\163\057"
  "\001\000\000\000\157\162\147\057\002\000\000\000" };

static GStaticResource static_resource = { vector_resource_data.data, sizeof (vector_resource_data.data) - 1 /* nul terminator */, NULL, NULL, NULL };

G_MODULE_EXPORT
GResource *vector_get_resource (void);
GResource *vector_get_resource (void)
{
...
#ifdef G_DEFINE_CONSTRUCTOR_NEEDS_PRAGMA
#pragma G_DEFINE_CONSTRUCTOR_PRAGMA_ARGS(vectorresource_constructor)
#endif
G_DEFINE_CONSTRUCTOR(vectorresource_constructor)
#ifdef G_DEFINE_DESTRUCTOR_NEEDS_PRAGMA
#pragma G_DEFINE_DESTRUCTOR_PRAGMA_ARGS(vectorresource_destructor)
#endif
G_DEFINE_DESTRUCTOR(vectorresource_destructor)

#else
#warning "Constructor not supported on this compiler, linking in resources will not work"
#endif

static void vectorresource_constructor (void)
{
  g_static_resource_init (&static_resource);
}

static void vectorresource_destructor (void)
{
